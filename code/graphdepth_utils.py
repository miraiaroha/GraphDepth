...
def load_params_from_parser():
    ...
    parser.add_argument('--rgbdir',   type=str,   help='path to the trainset', required=True)
    parser.add_argument('--depth', '--dep', type=str, help='path to the trainset', required=True)
